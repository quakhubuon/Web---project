...
<section style="margin-top: 80px;" class="jumbotron text-center">
	<div class="container">
		<h1 class="jumbotron-heading">Detail orders</h1>
	</div>
</section>
	...
	<%
		...
		List<Item> items = detailDAO.selectAllItem(id);
	%>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						...
						%>
						<tr>
							<td><%= i.getProduct().getPro_name() %></td>
							<td><img src="images/<%= i.getProduct().getImages() %>" width="100px"></td>
							<td><%= i.getProduct().getPrice() %></td>
							<td><%= i.getQuantity() %></td>
							<td><%= i.getQuantity() * i.getProduct().getPrice() %></td>
						</tr>
						<%
						}
						}
