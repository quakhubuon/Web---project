...
<%
	...
	int count = productDAO.getTotalProduct3(pro_id);
	int endPage = count / 3;
	if (count % 3 != 0) {
		endPage++;
	}

	List<Product> list = productDAO.pagingProduct3(pro_id, index);
		...
		<div class="box-container">
			...
			<div id="pagination">
				<c:forEach begin="1" end="${endP}" var="i">
					<a class="page-item" href="product.jsp?id=<%=pro_id%>&index=${i}">${i}</a>
				</c:forEach>
			</div>
	</section>
