...
<body>
    ...
    <section class="dishes" id="dishes">
        ...
        <div class="box-container">
            ...
            $cat_id = $_GET["id"];
            $options = "?id=".$cat_id;
            $sqlPro = "SELECT * FROM tbl_product WHERE `status2` = 1 AND tbl_product.cat_id = $cat_id";
        ...
        ?>
            <div class="box">
                ...
                <a href="detail.php?id=<?php echo $rowProHome["pro_id"] ?>" class="fas fa-eye"></a>
        ...
        <div id="pagination">
            ...
            <a class="page-item" href="product.php<?=$options?>&p=<?=$i?>"><?=$i?></a>
            <?php endfor;?>
        </div>
    </section>
